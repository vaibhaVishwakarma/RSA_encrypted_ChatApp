...
export const sendMessage = async (req, res) => {
  try {
    ...
    // Adăugare timpi generare chei la mesaj pentru a fi afișați ulterior
    newMessage.timeGeneratePublicKey = timeGeneratePublicKey;
    newMessage.timeGeneratePrivateKey = timeGeneratePrivateKey;
